 ...
 * 
 */
public class OntologyLoadProcessorServiceTest extends
...
//		FileItem ontologyFile = factory.createItem("file1", null, false, "test.obo");
		
		
//		DiskFileItem fileItem = new DiskFileItem("file1", null, true, "test.obo", 22, new File("/hello"));
