...
public class NcboOntologyMetadata extends AbstractNcboOntologyMetadata
	...
	/** full constructor */
	public NcboOntologyMetadata(NcboOntologyVersion ncboOntologyVersion,
			String oboFoundryId, String displayLabel, String format,
			String contactName, String contactEmail, String homepage,
			String documentation, String publication, String urn,
			String codingScheme, Byte isFoundry, String targetTerminologies) {
		super(ncboOntologyVersion, oboFoundryId, displayLabel, format,
