...
public class NcboLCategoryDAO extends HibernateDaoSupport {
	...
	public static final String OBO_FOUNDRY_NAME = "oboFoundryName";
	...
	public List findByOboFoundryName(Object oboFoundryName) {
		return findByProperty(OBO_FOUNDRY_NAME, oboFoundryName);
	}
