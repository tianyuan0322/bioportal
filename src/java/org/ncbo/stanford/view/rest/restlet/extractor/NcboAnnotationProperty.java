...
public class NcboAnnotationProperty {
	...
	public NcboAnnotationProperty(OWLOntologyManager manager,
			OWLOntology ontology, IRI id, String label, String lookupString)
			throws OWLOntologyChangeException {
		this.manager = manager;
		this.ontology = ontology;
		this.lookupString = lookupString;
		annotationProperty = manager.getOWLDataFactory()
				.getOWLAnnotationProperty(id);
