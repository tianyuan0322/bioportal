...
/**
 * This class provides utility methods to deal with different 
 * ontology metrics calculation. it was adapted from the 
 * "MetaAnalysis" Protege plug-in written by Amir Ghazvinian.
 * 
 * @author Csongor Nyulas
 *
 */
public class OntologyMetricsCalculator {
    
    private static final int GOOD_DESIGN_SUBCLASS_LIMIT = 10;
    ...
    public OntologyMetricsCalculator(KnowledgeBase kb, 
    		String documentationProperty, String authorProperty, String propertyWithUniqueValue, Integer preferredMaximumSubclassLimit) {
    	this.kb = kb;
    	this.documentationProperty = documentationProperty;
    	this.authorProperty = authorProperty;
    	this.annotationProperty = propertyWithUniqueValue;
    	this.preferredMaximumSubclassLimit = (preferredMaximumSubclassLimit == null ? 
    			GOOD_DESIGN_SUBCLASS_LIMIT : preferredMaximumSubclassLimit.intValue());
    }
