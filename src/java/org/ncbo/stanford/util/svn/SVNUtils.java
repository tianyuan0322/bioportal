...
public class SVNUtils {
 ...
 public  void svnCheckout() {
		...
		try {
				...
				authManager = SVNWCUtil.createDefaultAuthenticationManager(svnUsername,svnPassword);
				...
				uc.doCheckout(svnurl, dstPath, SVNRevision.UNDEFINED, SVNRevision.HEAD, true);
