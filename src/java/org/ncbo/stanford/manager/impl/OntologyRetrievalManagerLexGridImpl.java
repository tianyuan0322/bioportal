...
public class OntologyRetrievalManagerLexGridImpl extends AbstractOntologyManagerLexGrid implements
    ...
    private CodedNodeSet unionedCodedNodeSet(List<VNcboOntology> ontologyVersions) throws Exception {

        CodedNodeSet unionedCNS = null;
        for (VNcboOntology ontologyVersion : ontologyVersions) {
            String schemeName = getLexGridCodingSchemeName(ontologyVersion);
            CodingSchemeVersionOrTag csvt = getLexGridCodingSchemeVersion(ontologyVersion);
            ...
            if (unionedCNS == null) {
                ...
                unionedCNS = unionedCNS.union(cns);
            }
        }
        return unionedCNS;
