 ...
 * Java side, the map provides/expects the integer id of that value.
 * <p>
...
public class ObjectIdPropertyMap extends ObjectPropertyMap {
	...
	public Object prepareValueForOWL(Object value) throws MetadataException {
		if (value instanceof Integer) {
			return retrieveIndividualForId(owlClassName, (Integer)value);
		} else {
	...
	public Object handleValueFromOWL(Object value) {
		if (value == null) {
			...
			return getIdFromIndividual((OWLIndividual)value);
		} else {
