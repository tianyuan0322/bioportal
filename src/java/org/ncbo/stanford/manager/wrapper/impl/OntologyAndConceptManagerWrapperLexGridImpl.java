 ...
 * 
 */
public class OntologyAndConceptManagerWrapperLexGridImpl extends OntologyAndConceptManagerWrapper {

	private static final Log log = LogFactory
			.getLog(OntologyAndConceptManagerWrapperLexGridImpl.class);
