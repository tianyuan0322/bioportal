 ...
 */
public interface BeanCRUDService<BeanType extends MetadataBean> {

	/**
	 * Creates a fresh bean; add values and save to create a new object in
	 * the persistent store.
	 */
	public BeanType newBean();
	
	/**
	 * Forwards to the equivalent manager method.
	 * 
	 * @see org.ncbo.stanford.manager.metakb.SimpleObjectManager#saveObject()
	 */
