...
public class ConceptServiceImpl implements ConceptService {
	...
	public List<SearchResultBean> findConceptNameExact(
		...
		for (NcboOntology ontology : ontologies) {
			if (ontology.getStatusId().equals(
				...
				((List<NcboOntology>) formatLists.get(formatHandler))
						.add(ontology);
			}
		}
	...
	/*
	 * public List<ClassBean> findParent(int ontologyId, String id) throws
	 * Exception { return ontologyRetrievalManager.findParent(ontologyId, id); }
	 * 
	 * public List<ClassBean> findChildren(int ontologyId, String id ) throws
	 * Exception { return ontologyRetrievalManager.findChildren(ontologyId, id); }
	 */
