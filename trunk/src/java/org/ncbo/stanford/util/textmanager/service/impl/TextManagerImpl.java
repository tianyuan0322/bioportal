 ...
 * @author Michael Dorf
 * 
 * Provides the main engine class for TextManager.
 * Contains all public API.
 */
...
//	}
	...
	*/	
	...
	/**
	 * Returns content for a given text identifier using 
	 * the specified source:
	 * 		CoreConstants.FROM_DB [default]
	 * 		CoreConstants.FROM_CACHE
	 * 
	 * @param textIdent - a text identifier
	 * @param sourceFlag (FROM_DB/FROM_CACHE)
	 * @return the processed content
	*/	
	 ...
	 * 
	 * @param textIdent - text identifier
	...
	/**
	 * Adds a keyword into the tag processor's keyword collection,
	 * used to define dynamically generated values inside a text
	 * 
	 * @param the key
	 * @param the value
	...
	*/	
	...
	/**
	 * Returns the value of a keyword identified
	 * by the given key
	 * 
	 * @param the key of the keyword
	...
	*/	
	...
	/**
	 * @param ncboAppTextDAO the ncboAppTextDAO to set
	 */
